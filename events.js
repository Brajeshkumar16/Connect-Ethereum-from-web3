...
async function main() {
    ...
    //     // console.log(from, to, value, decimals)
    //     console.log(from, to, value, decimals,data.transactionHash)
        
    // })

    contract.on("Approval", (owner, sender, value)=> {
        console.log(owner, sender, value, decimals)
    });
